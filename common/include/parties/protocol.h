...
enum class ControlMessageType : uint16_t {
    ...
    // Webcam
    CAMERA_SHARE_START    = 0x000B,
    CAMERA_SHARE_STOP     = 0x000C,
    CAMERA_SHARE_VIEW     = 0x000D,   // Subscribe to a sharer's camera [target_user_id(4)], 0 = unsubscribe
...
constexpr uint8_t CAMERA_FRAME_PACKET_TYPE = 0x05;  // Webcam frames

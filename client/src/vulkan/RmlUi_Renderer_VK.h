...
class RenderInterface_VK : public ExtendedRenderInterface {
public:
	...
	RenderInterface_VK(void* native_window, const Backend::RmlRendererSettings& settings);
	~RenderInterface_VK();
	...
	// YUV (I420) — CPU conversion to RGBA, rendered via normal texture path
	...
	// NV12 — CPU conversion to RGBA, rendered via normal texture path

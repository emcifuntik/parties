...
elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL x64)
  string(APPEND arch_flags " -msse4.1")
endif()
# /Za unknown
...
if(VCPKG_USE_SANITIZERS)
    ...
    if(NOT VCPKG_USE_COMPILER_FOR_LINKAGE)
      ...
      if(VCPKG_CRT_LINKAGE STREQUAL "dynamic")
        ...
        set(sanitizer_libs "clang_rt.asan-x86_64.lib")
...
set(CMAKE_C_FLAGS_RELEASE "/O2 /Oi /Gw /Gy ${CLANG_FLAGS_RELEASE} ${VCPKG_C_FLAGS_RELEASE} ${VCPKG_CRT_FLAG} ${CLANG_C_LTO_FLAGS} ${VCPKG_DBG_FLAG} /DNDEBUG" CACHE STRING "")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CL_NOLOGO} /EHsc ${_VCPKG_RTTI_DISABLE_FLAGS} ${windows_defs} ${arch_flags} ${VCPKG_CXX_FLAGS} ${CLANG_FLAGS} ${CHARSET_FLAG} ${std_cxx_flags} ${ignore_werror}" CACHE STRING "")
